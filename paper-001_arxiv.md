...
**Violation:** PAPER had CANON.md but no source specification (PAPER-00-SPEC.md). AI had edited CANON.md directly, violating governance model.

**Governance model:**
- Humans iterate specs (CANONIC.md, WRITING.md, PAPER-00-SPEC.md)
...
1. Create PAPER-00-SPEC.md specification (producer commit)
2. Move episodes to paper/episodes/ (canonical locality)
3. Remove episodes from writing/episodes/ (consumer commit)
4. Regenerate CANON.md from PAPER-00-SPEC.md (consumer commit)
...
# a2e977e Apply spec to regenerate CANON.md from PAPER-00-SPEC.md
# dcaf6bc Apply canonical locality: Move episodes to paper repo
# e16bcd3 Canonify paper specification in PAPER-00-SPEC.md
...
**Significance:** Demonstrates constitutional enforcement through human governance. AI violated spec requirement. Governor General detected immediately. Recovery executed through producer/consumer commit sequence (1 producer: Canonify PAPER-00-SPEC.md, 4 consumers: Apply spec changes).
